  ...
  <div class="head">
    <ul class="nav">
      <li v-for="(item,key) of navs" :key="key">
        <a :class="{'active':$route.path == item.p}" href="javascript:;" @click="$router.push(item.p)" v-text="item.t"></a>
        <!-- <router-link :to="{path:'/html'}" exact event="click">HTML</router-link> -->
      </li>
      <!-- <li>
        <router-link :to="'about:blank'" exact event="click">REACT</router-link>
      </li>
      <li>
        <router-link :to="'about:blank'" exact event="click">REACT</router-link>
      </li>
